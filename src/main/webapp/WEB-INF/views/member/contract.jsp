...
<script type="text/javascript" src="js/jquery-3.6.0.min.js"></script>
  ...
  <div id="info">
    ...
    <form id="join" action="join_form" method="post" name="formm">
        언제나 새로운 즐거움이 가득한 GYM의 회원가입 페이지 입니다. <br>
       GYm의 회원가입은 무료이며, 회원님의 개인신상에 관한 정보는 <br>
...
(3) 서비스 이용으로 발생한 분쟁에 대해 소송이 제기되는 경우 회사의 본사 소재지를 관할하는 법원을 관할 법원으로 합니다.
      ...
      <input type="button" value="Next" class="submit" onclick="go_next()" style="float: center;width: 100px; height:30px; margin-top:20px;">
      <input type="button" value="돌아가기" onclick="location.href='index'" style="float: center;width: 100px; height:30px; margin-top:20px;"> 
    </form>
    </div>
</div>
